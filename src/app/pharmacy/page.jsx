...
export default function PharmacyPage() {
  ...
  const pharmacyServices = [
    {
      ...
      icon: <Pill className="h-10 w-10 text-green-600 dark:text-green-400 mb-4" />,
    },
    {
      title: "Medication Delivery",
      description: "Home delivery service for medications within our service area.",
      icon: <Truck className="h-10 w-10 text-green-600 dark:text-green-400 mb-4" />,
    },
    {
      title: "Medication Management",
      description: "Personalized medication reviews and management plans.",
      icon: <FileText className="h-10 w-10 text-green-600 dark:text-green-400 mb-4" />,
    },
    {
      title: "Automatic Refills",
      description: "Convenient automatic refill program for maintenance medications.",
      icon: <Repeat className="h-10 w-10 text-green-600 dark:text-green-400 mb-4" />,
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300">Monday - Friday: 8am - 8pm</p>
                <p className="text-gray-700 dark:text-gray-300">Saturday: 9am - 5pm</p>
                <p className="text-gray-700 dark:text-gray-300">Sunday: 10am - 4pm</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <h3 className="font-semibold text-green-800 dark:text-green-400 mb-1">Contact</h3>
                <p className="text-gray-700 dark:text-gray-300">Pharmacy Direct: (123) 456-7895</p>
                <p className="text-gray-700 dark:text-gray-300">Refill Line: (123) 456-7896</p>
                <p className="text-gray-700 dark:text-gray-300">Email: pharmacy@God's Knot.com</p>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-green-100 dark:bg-green-800 p-3 rounded-full mr-4">
                <CalendarClock className="h-6 w-6 text-green-700 dark:text-green-300" />
              </div>
              <div>
                <h3 className="font-semibold text-green-800 dark:text-green-400 mb-1">Prescription Refills</h3>
                <p className="text-gray-700 dark:text-gray-300">Online: Available 24/7</p>
                <p className="text-gray-700 dark:text-gray-300">Phone: During pharmacy hours</p>
                <p className="text-gray-700 dark:text-gray-300">Mobile App: Available 24/7</p>
              </div>
            </motion.div>
          </div>
        </div>
            ...
            <motion.div variants={fadeIn}>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-green-700 dark:text-green-400">Medication Safety</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-green-700 dark:text-green-400">Medication Counseling</h4>
                    <p className="text-gray-600 dark:text-gray-400">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-green-700 dark:text-green-400">Specialized Medications</h4>
                    <p className="text-gray-600 dark:text-gray-400">Access to specialty and hard-to-find medications</p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-green-50 dark:bg-green-900/20">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-green-900 dark:text-green-400 mb-4">Our Pharmacy Services</h2>
          ...
          >
            {pharmacyServices.map((service, index) => (
              <motion.div key={service.title} variants={fadeIn}>
                <Card className="border-green-100 dark:border-green-800 h-full dark:bg-gray-800">
                  <CardHeader className="pb-2">
                    {service.icon}
                    <CardTitle className="text-xl text-green-800 dark:text-green-400">{service.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <Card className="border-green-100 dark:border-green-800 h-full dark:bg-gray-800">
                <CardHeader>
                  <CardTitle className="text-green-800 dark:text-green-400">Immunization Services</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            >
              <Card className="border-green-100 dark:border-green-800 h-full dark:bg-gray-800">
                <CardHeader>
                  <CardTitle className="text-green-800 dark:text-green-400">Health & Wellness Products</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
      ...
      {/* Call to Action */}
      <section className="py-16 bg-green-800 dark:bg-green-900">
        <div className="container mx-auto px-4">
          <motion.div
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button className="bg-white text-green-800 hover:bg-green-100 dark:hover:bg-green-50">
